...
private:
	...
	const std::wstring wegameProcessName1 = L"tgp_daemon.exe";
	const std::wstring wegameProcessName2 = L"wegame.exe";
...
public:
	...
	void CheckStateTransition() {
		bool isWegameRunning1 = IsProcessRunning(wegameProcessName1);
		bool isWegameRunning2 = IsProcessRunning(wegameProcessName2);
		bool isWegameRunning = isWegameRunning1 || isWegameRunning2;
		...
		//	LOG_IMMEDIATE("------VAL isWegameRunning: ");
		//}
		//if (isGameRunning)
		//{

		//	LOG_IMMEDIATE("------VAL isGameRunning: ");
		//}

		//if (isLogIn)
		//{

		//	LOG_IMMEDIATE("------VAL isLogIn: ");
		//}
